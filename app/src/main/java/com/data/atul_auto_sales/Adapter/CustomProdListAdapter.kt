...
class CustomProdListAdapter(var context: Activity, var list: List<LeadDetailBean.Data.CustomProduct>, var rvClickListner: RvStatusClickListner) : RecyclerView.Adapter<CustomProdListAdapter.MyViewHolder>(){
